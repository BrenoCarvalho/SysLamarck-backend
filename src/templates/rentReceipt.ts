...
<body>
    <header>
        <div class="cabeça">
            ...
            <p style="text-align: center;">Rua Dr. Carlos Autran N 15 - Centro, LORENA/SP. CEP. 12600-160 TEL .: (12) 3152-1099 / 3152-1541 CRECI- 30558-J
            </p>
        </div>           
    </header>
    <div class="linha">
  ...
  <body>
    <div class="container">
      <section class="section">
        ...
        <p><b>Data Pagamento:</b> {{installment.paymentDate}} / <b>N° PARCELA:</b> {{installment.currentInstallment}} / <b>CÓD:</b>{{property.propertyCode}}</p>
        <div class="linha">
